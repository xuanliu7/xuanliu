...
#### Improving the Measurement and Characterization of Mineral Dust

Accurately quantifying dust concentration and composition is essential for assessing its impacts on air quality and health and for evaluating the models used to predict them, yet widely used measurement approaches carry underappreciated biases. I develop methods to improve the quantification and characterization of mineral dust. My work includes a new approach for more accurately estimating dust mass from elemental measurements that accounts for regional variability in dust composition, as well as an empirical correction for previously overlooked attenuation biases in aerosol measurements using X-ray fluorescence. I have developed QA/QC approaches for dust measurements within a global surface particulate matter (PM) monitoring network, [SPARTAN](https://www.spartan-network.org/), and characterized dust and trace elements, their sources, and potential health risks. I have also conducted ambient PM measurements in Central Asia, providing new observations of dust concentration and composition in a region where such measurements remain limited.

- Liu, X., Turner, J. R., Hand, J. L., Schichtel, B. A., & Martin, R. V. (2022). A Global-Scale Mineral Dust Equation. *Journal of Geophysical Research: Atmospheres*, 127(18), e2022JD036937. [doi.org/10.1029/2022JD036937](https://doi.org/10.1029/2022JD036937)
